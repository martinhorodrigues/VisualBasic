...
<body style="font-family: 'Segoe UI', Arial, sans-serif">
    ...
    <div>
        ...
        <br />
        <div id="MessageColumn" style="width:30%; background-color:purple; float:left">
            <asp:Label ID="lblMsg" runat="server" ForeColor="White" Text="Label"></asp:Label>
        </div>
        <div id="ContentColumn" style="width:39%; float:left">
                ...
                <asp:TableRow ID="tblRow4" runat="server">
                    <asp:TableCell ID="tblRow4Col1" runat="server">Email:
